...
static const unsigned long FIXED_P[18] = 
{
...
static const unsigned long FIXED_S[4][256] = 
{
	...
	0xC5C43465, 0x713E38D8, 0x3D28F89E, 0xF16DFF20, 0x153E21E7, 0x8FB03D4A, 0xE6E39F2B, 0xDB83ADFL},
...
int main(int argc, char *argv[])
{
	...
	unsigned long count;
	printf("Выберите действие:\n1 - зашифровать файл, 2 - дешифровать файл: ");
	scanf("%d",&type);
	if(type < 1 || type > 2) 
	{
		errno = EINVAL;
	...
	printf("Введите ключ, используя клавиатуру: ");
	scanf("%s",key);
	...
	while(++i < keylen) 
	{
		...
		{
			perror("Ошибка ввода! Введите другой ключ(от 4 до 56 байт)");
			return -1;
		}
		...
		if(fp1 == NULL) 
		{
			perror("Невозможно открыть данный файл");
			return errno;
		}
		blowfish_ctx ctx;
